...
export type BridgeToCloudMessage = {
    ...
    payload: BridgeRegistrationMessage;
} | {
    type: "bridge.heartbeat";
    payload: BridgeHeartbeatMessage;
} | {
    type: "bridge.assignment_accepted";
    payload: BridgeAssignmentAcceptedMessage;
} | {
    type: "bridge.execution_started";
    payload: BridgeExecutionStartedMessage;
} | {
    type: "bridge.execution_progress";
    payload: BridgeExecutionProgressMessage;
} | {
    type: "bridge.execution_completed";
    payload: BridgeExecutionCompletedMessage;
} | {
    type: "bridge.execution_failed";
    payload: BridgeExecutionFailedMessage;
};
...
export declare const bridgeAckSchema: z.ZodObject<{

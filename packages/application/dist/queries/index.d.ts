...
export interface GetRequestQuery extends Query<"request.get", {
    requestId: string;
}> {
}
export interface GetWorkflowRunQuery extends Query<"workflow_run.get", {
    workflowRunId: string;
}> {
}
export interface ListTasksQuery extends Query<"task.list", {
    workflowRunId: string;
}> {
}

...
// ── RequestRepository ────────────────────────────────────────────────────
export function requestRepositoryTests(createRepo) {
...
// ── WorkspaceRepository ──────────────────────────────────────────────────
export function workspaceRepositoryTests(createRepo) {
    return {
        async "save and getById round-trip preserves all fields"() {
            const repo = createRepo();
...
// ── WorkflowRepository ───────────────────────────────────────────────────
export function workflowRepositoryTests(createRepo) {
    return {
        async "save and getById round-trip preserves all fields"() {
            const repo = createRepo();
...
export function workflowRunRepositoryTests(createRepo) {
    return {
        async "save and getById round-trip preserves all fields"() {
            const repo = createRepo();
...
// ── TaskRepository ───────────────────────────────────────────────────────
export function taskRepositoryTests(createRepo) {
    return {
        async "save and getById round-trip preserves all fields"() {
            const repo = createRepo();
...
export function assignmentRepositoryTests(createRepo) {
    return {
        async "save and getById round-trip preserves all fields"() {
            const repo = createRepo();
...
export function executionSessionRepositoryTests(createRepo) {
    return {
        async "save and getById round-trip preserves all fields"() {
            const repo = createRepo();

...
// ── DomainEventStore ────────────────────────────────────────────────────
export function eventStoreContracts(createStore) {
    const makeEvent = (type, version, aggregateId) => ({
        type,
...
// ── OutboxRepository ────────────────────────────────────────────────────
export function outboxRepositoryContracts(createRepo) {
    const makeRecord = (id) => ({
        id,
        workspaceId: "ws-1",
        event: {
...
// ── IdempotencyStore ────────────────────────────────────────────────────
export function idempotencyStoreContracts(createStore) {
    return {

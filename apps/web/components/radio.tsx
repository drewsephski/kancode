...
export default function LiquidRadio() {
    ...
    return (
        <div className="inline-flex h-9 rounded-lg bg-input/50 p-0.5">
            ...
            >
                ...
                />
                <label className="relative z-10 inline-flex h-full min-w-8 cursor-pointer select-none items-center justify-center whitespace-nowrap px-6 font-medium transition-colors text-muted-foreground/70 group-data-[state=online]:text-muted-foreground/70 group-data-[state=offline]:text-foreground">
                    Development
                    <RadioGroupItem id="env-offline" value="offline" className="sr-only" />
                </label>
                <label className="relative z-10 inline-flex h-full min-w-8 cursor-pointer select-none items-center justify-center whitespace-nowrap px-6 font-medium transition-colors text-muted-foreground/70 group-data-[state=offline]:text-muted-foreground/70 group-data-[state=online]:text-foreground">
                    Production
